...
data class DevUi(
    ...
    val onRunEval: () -> Unit = {},
    val objectEvalRunning: Boolean = false,
    val objectEvalSummary: com.claustrum.objects.ObjectEval.Summary? = null,
    val objectEvalStatus: String? = null,
    val onRunObjectEval: () -> Unit = {},
    val poseEvalRunning: Boolean = false,
    val poseEvalSummary: com.claustrum.events.FallVideoEval.Summary? = null,
    val poseEvalStatus: String? = null,
    val onRunPoseEval: () -> Unit = {},
